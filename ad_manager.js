...
function ad_admin() {
  ...
  s_gameP.style.display = "none";                                  //<=======
  s_landingP.style.display = "none";                                  //<=======
  s_adminP.style.display = "block";                                  //<=======
  s_regP.style.display = "none";
...
function ad_home() {
  ...
  s_landingP.style.display = "block";                                 //<=======
}
...
function ad_user() {
  ...
  document.getElementById("b_adXO").style.backgroundColor = "grey";
...
/**************************************************************/
// ad_XO()
// Input event; called when admin XO button clicked
// Display XO screen
// Input:   
// Return:
/**************************************************************/
function ad_XO() {
  ...
  document.getElementById("b_adXO").style.backgroundColor = "cyan";
  document.getElementById("b_adUser").style.backgroundColor = "grey";
  document.getElementById("b_adHome").style.backgroundColor = "grey";
  // ENSURE THE READ FUNCTION NAME & THE PATH NAME ARE CORRECT           //<=======
  fb_readAll(XO, ad_processXOReadAll);                                   //<=======
}
...
function ad_processUSERReadAll(_result, _dbRec) {
  ...
  if (_result == 'OK') {
    ...
    ad_displayAll("t_userData", ad_adminArray, true,
      "s_landingP", "s_gameP", "s_adminP", 7, DETAILS);        //<=======
  }
}

/**************************************************************/
// ad_processXOReadAll(_result, _dbRec)
// Called by db_readAll to handle result of read ALL XO records request.
// Save data & update display with record info
// Input:  read status, data record just read
// Return:
/**************************************************************/
function ad_processXOReadAll(_result, _dbRec) {
  console.log('ad_processXOReadAll: ', 'result = ' + _result);
...
// Called by ad_dbRAllUResult & ad_dbRAllXOResult
